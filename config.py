...
API_ID = int(getenv("21636907"))
API_HASH = getenv("54d4151f3586ab81f8e57c808d3ee3b0"")

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("7732173919:AAFWPkGpVWZZ_9dwqE8G5oWhOJuf8aBq3h0")
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","DEADCALAM")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","Anya_lip_bot")
# --------------------------------------------------------
BOT_NAME = getenv("Anya_lip_bot")
# ---------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Gxtoxic4563/SONALI_MUSIC",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/5e19b207529494cbbd9a1-a96ede1789dd2f2c9b.jpg"
)
PING_IMG_URL = getenv(
